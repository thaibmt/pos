...
//duong dan den model lay du lieu menu
use App\menu;
use App\slide;
use App\about;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $menu1=menu::all();//lay tat ca du lieu menu
        $slide=slide::all();//lay tat ca du lieu slide
        $about[]=about::all();
        view::share('Menu',$menu1);//bien Menu dung chung cho tat ca ca view
        view::share('Slide',$slide);//bien slide dung chung cho tat ca ca view
        view::share('About',$about);//du lieu lay tu bang about do ra view about.blade.php
    }
