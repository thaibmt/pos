...
Route::middleware(['IsInstalled', 'auth', 'SetSessionData', 'language', 'timezone', 'bootstrap'])->group(function () {
    ...
    Route::get('/inventory', 'HomeController@index')->name('home');
...
Route::get('/delete-proimg/{proimgid}', 'ProductController@deleteProImg');
	...
	//them product images
	  Route::get('/products/images/{idpro}', 'ProductController@getProductsimages');
	  //////////
