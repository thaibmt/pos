        ...
        <div class="row">
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                {!! Form::file('image[]', ['id' => 'upload_image', 'accept' => 'image/*','multiple' => 'multiple']); !!}
              ...
              <div class="form-group">
                <?php
                   $linkimg= asset('/uploads/'.config('constants.product_img_path').'/'.$product->image);
                    //  echo $linkimg;
                      $ihtml = '<img src="' . $linkimg . '" style="width:50%" >';
                      echo $ihtml;
                  ?>
              </div>
            </div>
            ...
            <style>
              ...
              .img-wrap .close {
                  ...
                  right: 2px;
                  z-index: 100;
                 background: url({{asset('img/details_close.png')}});
              }
            </style>
            <div class="clearfix"></div>
               <div class="col-sm-12">
                <h3> Hình ảnh thêm của sản phẩm: </h3>
                  <div class="form-group">
                    <?php 

                     $arrayimg = $product->images->toArray();
                     $j =0;
                     for ($j = 0; $j < count($arrayimg) ;$j ++)
                     {
                      //   var_dump($arrayimg[$j]);
                     //    echo $arrayimg[$j]['imageurl'];
                    //     echo '<br/>';
                      $linkimg= asset('/uploads/'.config('constants.product_img_path').'/'.$arrayimg[$j]['imageurl']);
                    //  echo $linkimg;
                      $ihtml = '<img src="' . $linkimg . '" width="60" height="60" >';
                     //   echo '<div class="img-wrap">  <span class="close">&times;</span><img src="'.$arrayimg[$j]->imageurl.'"></div>';
                     ?>
                          <div class="img-thumbnail">
                            <span class="badge bg-red delete-media"
                             data-href="{{action('ProductController@deleteProImg', ['proimgid' => $arrayimg[$j]['id']])}}"><i class="fa fa-close"></i></span>
                                    <?php echo $ihtml; ?>
                                </div>
